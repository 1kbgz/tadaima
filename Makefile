...
lint-py:  ## run python linter with ruff
	python -m ruff check tadaima
	python -m ruff format --check tadaima
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix tadaima
	python -m ruff format tadaima
...
test-py:  ## run python tests
	python -m pytest -v tadaima/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v tadaima/tests --cov=tadaima --cov-report term-missing --cov-report xml
